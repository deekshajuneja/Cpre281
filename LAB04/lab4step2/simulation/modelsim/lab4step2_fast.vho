...
ARCHITECTURE structure OF lab4step2 IS
...
-- Equation(s):
-- \WideOr0~0_combout\ = (\C~combout\ & (!\A~combout\ & ((\D~combout\) # (\B~combout\)))) # (!\C~combout\ & (\A~combout\ & ((!\B~combout\) # (!\D~combout\))))
