...
ARCHITECTURE structure OF lab3step2 IS
...
-- Equation(s):
-- \F~0_combout\ = (\W~combout\ & (!\G~combout\ & \C~combout\)) # (!\W~combout\ & (\G~combout\ & !\C~combout\))
