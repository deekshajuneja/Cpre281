...
ARCHITECTURE structure OF lab10step3a1 IS
...
-- Equation(s):
-- \inst8|WideOr0~0_combout\ = (\inst2~regout\ & (!\inst1~regout\ & (\inst~regout\ $ (!\inst3~regout\)))) # (!\inst2~regout\ & (\inst~regout\ & (\inst1~regout\ $ (!\inst3~regout\))))
...
-- Equation(s):
-- \inst8|WideOr1~0_combout\ = (\inst1~regout\ & ((\inst~regout\ & ((\inst3~regout\))) # (!\inst~regout\ & (\inst2~regout\)))) # (!\inst1~regout\ & (\inst2~regout\ & (\inst~regout\ $ (\inst3~regout\))))
...
-- Equation(s):
-- \inst8|WideOr2~0_combout\ = (\inst2~regout\ & (\inst3~regout\ & ((\inst1~regout\) # (!\inst~regout\)))) # (!\inst2~regout\ & (\inst1~regout\ & (!\inst~regout\ & !\inst3~regout\)))
...
-- Equation(s):
-- \inst8|WideOr3~0_combout\ = (\inst1~regout\ & ((\inst~regout\ & (\inst2~regout\)) # (!\inst~regout\ & (!\inst2~regout\ & \inst3~regout\)))) # (!\inst1~regout\ & (!\inst3~regout\ & (\inst~regout\ $ (\inst2~regout\))))
...
-- Equation(s):
-- \inst8|WideOr4~0_combout\ = (\inst1~regout\ & (\inst~regout\ & ((!\inst3~regout\)))) # (!\inst1~regout\ & ((\inst2~regout\ & ((!\inst3~regout\))) # (!\inst2~regout\ & (\inst~regout\))))
...
-- Equation(s):
-- \inst8|WideOr5~0_combout\ = (\inst1~regout\ & (!\inst3~regout\ & ((\inst~regout\) # (!\inst2~regout\)))) # (!\inst1~regout\ & (\inst~regout\ & (\inst2~regout\ $ (!\inst3~regout\))))
...
-- Equation(s):
-- \inst8|WideOr6~0_combout\ = (\inst~regout\ & ((\inst3~regout\) # (\inst1~regout\ $ (\inst2~regout\)))) # (!\inst~regout\ & ((\inst1~regout\) # (\inst2~regout\ $ (\inst3~regout\))))
